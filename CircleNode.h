...
private:
    ...
    /** @brief The following function takes a collection of string vectors and adds the label of the circle to the circle_labels vector. */
    ...
    void (CircleNode::*definition)() {nullptr}; /**< @brief Function pointer indicating the definition of the circle. */
